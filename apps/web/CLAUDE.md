...
├── components/         # переиспользуемые React-компоненты (register-form.tsx, login-form.tsx, dashboard.tsx — клиентские, на HeroUI)
