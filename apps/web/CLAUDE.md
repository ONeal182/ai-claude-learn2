...
├── components/         # переиспользуемые React-компоненты (register-form.tsx, login-form.tsx, dashboard.tsx, meeting-details.tsx, meeting-files.tsx, profile-view.tsx — клиентские, на HeroUI; avatar.tsx — аватар пользователя: <img> по avatarSrc с фолбэком на инициалы)
